...
_Generated by `scripts/sync_env.py --docs` on 2025-11-16T16:07:02.412619Z._
...
| TRAEFIK_BASIC_AUTH | {{ basic_auth \| quote }} | template & j2 |
| TRAEFIK_DOMAIN | {{ stack_domain }} | template & j2 |
| TRAEFIK_LE_EMAIL | {{ stack_email }} | template & j2 |
...
| OLLAMA_KV_CACHE_TYPE | {{ ollama_kv_cache_type \| default('') }} | template & j2 |
| OLLAMA_ROCM_ENABLED | {{ (ollama_use_rocm_overlay \| bool) \| ternary('true', 'false') }} | template & j2 |
| OLLAMA_ROCM_DEVICE_KFD | {{ ollama_rocm_device_kfd \| default('/dev/kfd') }} | template & j2 |
| OLLAMA_ROCM_DEVICE_DRI | {{ ollama_rocm_device_dri \| default('/dev/dri') }} | template & j2 |
| OLLAMA_ROCM_SECCOMP | {{ ollama_rocm_seccomp \| default('unconfined') }} | template & j2 |
| OLLAMA_ROCM_HSA_OVERRIDE_GFX_VERSION | {{ ollama_rocm_hsa_override_gfx_version \| default('') }} | template & j2 |
| OLLAMA_ROCM_HSA_ENABLE_SDMA | {{ ollama_rocm_hsa_enable_sdma \| default('0') }} | template & j2 |
| OLLAMA_ROCM_HSA_NO_SCRATCH_RECLAIM | {{ ollama_rocm_hsa_no_scratch_reclaim \| default('1') }} | template & j2 |
| OLLAMA_ROCM_ROCR_VISIBLE_DEVICES | {{ ollama_rocm_rocr_visible_devices \| default('0') }} | template & j2 |
| OLLAMA_ROCM_HIP_VISIBLE_DEVICES | {{ ollama_rocm_hip_visible_devices \| default('0') }} | template & j2 |
| OLLAMA_ROCM_HSA_VISIBLE_DEVICES | {{ ollama_rocm_hsa_visible_devices \| default('0') }} | template & j2 |
...
| TS_HOSTNAME | {{ ts_hostname \| default('') }} | template & j2 |
