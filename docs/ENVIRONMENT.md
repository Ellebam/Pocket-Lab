...
_Generated by `scripts/sync_env.py --docs` on 2025-09-03T23:49:02.423855Z._
...
| TEI_VERSION | {{ tei_version \| default('cpu-1.8') }} | template & j2 |
...
| LLM_API_BASE | {{ llm_api_base \| default("http://ollama:11434") }} | template & j2 |
| LLM_API_KEY | {{ llm_api_key \| default("") }} | template & j2 |
| LLM_ASR_MODEL | {{ llm_factory \| default("") }} | template & j2 |
| LLM_CHAT_MODEL | {{ llm_chat_model \| default("llama3.1:8b") }} | template & j2 |
| LLM_EMBEDDING_MODEL | {{ llm_embedding_model \| default("bge-m3") }} | template & j2 |
| LLM_FACTORY | {{ llm_factory \| default("Ollama") }} | template & j2 |
| LLM_IMAGE2TEXT_MODEL | {{ llm_image2text_model \| default("") }} | template & j2 |
| LLM_RERANK_MODEL | {{ llm_rerank_model \| default('onnx-community/bge-reranker-v2-m3-ONNX') }} | template & j2 |
