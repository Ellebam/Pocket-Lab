...
_Generated by `scripts/sync_env.py --docs` on 2025-07-02T13:54:46.791415Z._
...
| TRAEFIK_BASIC_AUTH | {{ basic_auth }}        # htpasswd‑style user:hash | template & j2 |
...
| OLLAMA_VERSION | {{ ollama_version \| default('0.1.30') }} | template & j2 |
...
| TG_CONNECTOR_VERSION | {{ tg_connector_version \| default('1.68.0') }} | template & j2 |
...
| TG_ACCESS_TOKEN_1 | {{ tg_access_token1 }} | template & j2 |
| TG_ACCESS_TOKEN_2 | {{ tg_access_token2 }} | template & j2 |
| TG_CONN1_NAME | {{ tg_container_name1 }} | template & j2 |
| TG_CONN2_NAME | {{ tg_container_name2 }} | template & j2 |
| TG_REFRESH_TOKEN_1 | {{ tg_refresh_token1 }} | template & j2 |
| TG_REFRESH_TOKEN_2 | {{ tg_refresh_token2 }} | template & j2 |
| TG_TENANT_NAME | {{ tg_tenant_name }} | template & j2 |
